...
var create = function () {
	...
	var createPage = suspend.promise(function * () {
		if (!initialized) throw new Error('Not initialized');
		var options = {
		...
		var get = function (property) {
			return new Promise(function (resolve, reject) {
				page.get(property, resolve);
			});
		};

		// Initialize page
		yield page.set('viewportSize', options.viewportSize, resumeRaw());
		...
		return {
			...
			injectJs: injectJs,
			set: page.set
			// TODO support setting page properties (i.e. `page.set()`)
		};
	});
	return {
